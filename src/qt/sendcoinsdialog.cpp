    ...
    model(0)
{
    ...
    ui->lineEditCoinControlChange->setPlaceholderText(tr("Enter a Coin address (e.g. 4Zo1ga6xuKuQ7JV7M9rGDoxdbYwV5zgQJ5)"));
#endif
...
struct	WalletModel::SendCoinsReturn sendstatus;
   ...
   switch(sendstatus.status)
    ...
    case WalletModel::InvalidAddress:
        QMessageBox::warning(this, tr("Send Tags"),
    ...
    case WalletModel::TransactionCommitFailed:
        QMessageBox::warning(this, tr("Send Tags"),
            tr("Error: The transaction was rejected. This might happen if some of the tags in your wallet were already spent, such as if you used a copy of wallet.dat and tags were spent in the copy but not marked as spent here."),
            QMessageBox::Ok, QMessageBox::Ok);
        break;
