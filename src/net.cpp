...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "SafeSeafood " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    {"Pacific", "pacific.safeseafoodcoin.com"},
    {"Atlantic", "atlantic.safeseafoodcoin.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    setsockopt(hListenSocket, SOL_SOCKET, SO_NOSIGPIPE, &nOne, sizeof(int));
#endif
#endif
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. SafeSeafood is probably already running."), addrBind.ToString().c_str());
        else
...
*/
    ...
    // safesea: mint proof-of-stake blocks in the background
