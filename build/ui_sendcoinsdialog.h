...
public:
    ...
    void retranslateUi(QDialog *SendCoinsDialog)
    {
        ...
        editTxComment->setToolTip(QApplication::translate("SendCoinsDialog", "Enter a transaction comment (Note: this information is public)", 0));
#endif // QT_NO_TOOLTIP
        ...
        labelCoinControlAmount->setText(QApplication::translate("SendCoinsDialog", "0.00 BTC", 0));
        ...
        labelCoinControlFee->setText(QApplication::translate("SendCoinsDialog", "0.00 BTC", 0));
        ...
        labelCoinControlAfterFee->setText(QApplication::translate("SendCoinsDialog", "0.00 BTC", 0));
        labelCoinControlChangeText->setText(QApplication::translate("SendCoinsDialog", "Change", 0));
        labelCoinControlChange->setText(QApplication::translate("SendCoinsDialog", "0.00 BTC", 0));
        ...
        labelBalance->setText(QApplication::translate("SendCoinsDialog", "123.456 STR", 0));
#ifndef QT_NO_TOOLTIP
